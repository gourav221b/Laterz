...
import { Trash2, RefreshCw, Clock, Calendar, Check } from "lucide-react"
...
export default function TaskList() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AnimatePresence>
        <Accordion type="multiple" className="space-y-4" defaultValue={filteredTasks.map(task => task.id.toString())}>
